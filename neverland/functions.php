		...
		$output .= '<div id="author-description">';
			...
			$output .= '<ul id="author-contacts">';
				...
				if (get_the_author_meta('twitter')) {
					...
					$output .= '<li class="author-contacts-item"><a href="https://twitter.com/#!/'.get_the_author_meta('twitter').'" title="Follow '.get_the_author_meta('twitter').' on Twitter" style="background:url(images/twitter.ico) no-repeat center left; padding-left: 18px;">'.get_the_author_meta('twitter').'</a></li>';
		
				}
				
				if (get_the_author_meta('kdelook')) {
					
					$output .= '<li class="author-contacts-item"><a href="http://kde-look.org/usermanager/search.php?username='.get_the_author_meta('kdelook').'" title="Follow '.get_the_author_meta('kdelook').' on kde-look(apps).org" style="background:url(images/kdelook.ico) no-repeat center left; padding: 18px;">'.get_the_author_meta('kdelook').'</a></li>';
				
				}
				
				if (get_the_author_meta('identica')) {
	
					$output .= '<li class="author-contacts-item"><a href="https://identi.ca/'.get_the_author_meta('identica').'" title="Follow '.get_the_author_meta('identica').' on Identi.ca" style="background:url(images/identica.ico) no-repeat center left; padding-left: 18px;">'.get_the_author_meta('identica').'</a></li>';
		
				}
				
				if (get_the_author_meta('plurk')) {
	
					$output .= '<li class="author-contacts-item"><a href="https://plurk.com/'.get_the_author_meta('plurk').'" title="Follow '.get_the_author_meta('plurk').' on Plurk" style="background:url(images/plurk.ico) no-repeat center left; padding-left: 18px;">'.get_the_author_meta('plurk').'</a></li>';
		
				}	
				
				if (get_the_author_meta('googleplus_url') && get_the_author_meta('googleplus_displayname')) {
	
					$output .= '<li class="author-contacts-item"><a href="'.get_the_author_meta('googleplus_url').'" title="Follow '.get_the_author_meta('googleplus_displayname').' on Google+" style="background:url(images/googleplus.ico) no-repeat center left; padding-left: 18px;">'.get_the_author_meta('googleplus_displayname').'</a></li>';
		
				}			

				if (get_the_author_meta('facebook_url') && get_the_author_meta('facebook_displayname')) {
	
					$output .= '<li class="author-contacts-item"><a href="'.get_the_author_meta('facebook_url').'" title="Follow '.get_the_author_meta('facebook_displayname').' on Facebook" style="background:url(images/facebook.ico) no-repeat center left; padding-left: 18px;">'.get_the_author_meta('facebook_displayname').'</a></li>';
		
				}
				
				if (get_the_author_meta('weibo_url') && get_the_author_meta('weibo_name')) {
	
					$output .= '<li class="author-contacts-item"><a href="'.get_the_author_meta('weibo_url').'" title="Follow '.get_the_author_meta('weibo_name').' on Sina Weibo" style="background:url(images/weibo.ico) no-repeat center left; padding-left: 18px;">'.get_the_author_meta('weibo_name').'</a></li>';
		
				}
				
				if (get_the_author_meta('douban_url') && get_the_author_meta('douban_name')) {
	
					$output .= '<li class="author-contacts-item"><a href="'.get_the_author_meta('douban_url').'" title="Follow '.get_the_author_meta('douban_name').' on Douban" style="background:url(images/douban.ico) no-repeat center left; padding-left: 18px;">'.get_the_author_meta('douban_name').'</a></li>';
		
				}

				if (get_the_author_meta('v2ex')) {
	
					$output .= '<li class="author-contacts-item"><a href="http://v2ex.com/member/'.get_the_author_meta('v2ex').'" title="Follow '.get_the_author_meta('v2ex').' on V2EX.com" style="background:url(images/v2ex.ico) no-repeat center left; padding-left: 18px;">'.get_the_author_meta('v2ex').'</a></li>';
		
				}
				
				if (get_the_author_meta('github')) {
	
					$output .= '<li class="author-contacts-item"><a href="https://github.com/'.get_the_author_meta('github').'" title="Fork '.get_the_author_meta('github').' on Github" style="background:url(images/github.ico) no-repeat center left; padding-left: 18px;">'.get_the_author_meta('github').'</a></li>';
		
				}
				
				if (get_the_author_meta('obs')) {
	
					$output .= '<li class="author-contacts-item"><a href="https://build.opensuse.org/project/show?project=home%3A'.get_the_author_meta('obs').'" title="'.get_the_author_meta('obs').'\'s Home Repository on OBS" style="background:url(images/obs.ico) no-repeat center left; padding-left: 18px;">'.get_the_author_meta('obs').'</a></li>';
		
				}
				
				if (get_the_author_meta('dribbble')) {
	
					$output .= '<li class="author-contacts-item"><a href="http://dribbble.com/'.get_the_author_meta('dribbble').'" title="Follow '.get_the_author_meta('dribbble').' on Dribbble" style="background:url(images/dribbble.png) no-repeat center left; padding-left: 18px;">'.get_the_author_meta('dribbble').'</a></li>';
		
				}
				
				if (get_the_author_meta('fiveoopx')) {
	
					$output .= '<li class="author-contacts-item"><a href="http://500px.com/'.get_the_author_meta('fiveoopx').'" title="Follow '.get_the_author_meta('fiveoopx').' on 500px.com" style="background:url(images/500px.ico) no-repeat center left; padding-left: 18px;">'.get_the_author_meta('fiveoopx').'</a></li>';
		
				}
				
				if (get_the_author_meta('tumblr')) {
	
					$output .= '<li class="author-contacts-item"><a href="http://www.tumblr.com/blog/'.get_the_author_meta('tumblr').'" title="Follow '.get_the_author_meta('tumblr').' on Tumblr" style="background:url(images/tumblr.png) no-repeat center left; padding-left: 18px;">'.get_the_author_meta('tumblr').'</a></li>';
		
				}
				
				if (get_the_author_meta('deviantart')) {
	
					$output .= '<li class="author-contacts-item"><a href="http://'.get_the_author_meta('deviantart').'.deviantart.com" title="Follow '.get_the_author_meta('deviantart').' on DeviantArt" style="background:url(images/deviantart.ico) no-repeat center left; padding-left: 18px;">'.get_the_author_meta('deviantart').'</a></li>';
		
				}
				
				if (get_the_author_meta('skype')) {
	
					$output .= '<li class="author-contacts-item"><a href="callto://'.get_the_author_meta('skype').'" title="Call '.get_the_author_meta('skype').' by Skype" style="background:url(images/skype.png) no-repeat center left; padding-left: 18px;">'.get_the_author_meta('skype').'</a></li>';
		
				}
				
				if (get_the_author_meta('imessage')) {
	
					$output .= '<li class="author-contacts-item" style="background:url(images/imessage.jpeg) no-repeat center left; padding-left: 18px">'.get_the_author_meta('imessage').'</li>';
		
				}
				
				if (get_the_author_meta('weixin')) {
	
					$output .= '<li class="author-contacts-item" style="background:url(images/weixin.gif) no-repeat center left; padding-left: 18px;">'.get_the_author_meta('weixin').'</li>';
		
				}
	
				if (get_the_author_meta('renren_url') && get_the_author_meta('renren_name')) {
	
					$output .= '<li class="author-contacts-item"><a href="'.get_the_author_meta('renren_url').'" title="Follow '.get_the_author_meta('renren_name').' on RenRen" style="background:url(images/renren.gif) no-repeat center left; padding-left: 18px;">'.get_the_author_meta('renren_name').'</a></li>';

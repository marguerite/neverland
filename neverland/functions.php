		...
		$output .= '<div id="author-description">';
			...
			$output .= '<ul id="author-contacts">';
				...
				if (get_the_author_meta('custom_url') && get_the_author_meta('custom_name') && get_the_author_meta('custom_servicename')) {
					...
					$output .= '<li class="author-contacts-item"><a href="'.get_the_author_meta('custom_url').'"  target="_blank" title="Follow '.get_the_author_meta('custom_name').' on '.get_the_author_meta('custom_servicename').'">'.get_the_author_meta('custom_name').'</a></li>';
